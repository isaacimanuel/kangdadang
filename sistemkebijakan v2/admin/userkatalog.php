...
?>
    ...
    <head>
        ...
        <title>SIEKA | Kelola User - Admin</title>
                                                        ...
                                                        <div class="modal-content">
                                                            ...
                                                            <form method="post">
                                                                <div class="modal-body">
                                                                    ...
                                                                    <small>Nama</small>
                                                                    <input type="text" name="nama" placeholder="Nama" value="<?= $nama; ?>" class="form-control mb-2" required>
                                                                    <small>Email</small>
                                                                    <input type="text" name="email" placeholder="Email" value="<?= $email; ?>" class="form-control mb-2" required>
            ...
            <div class="modal-content">
                ...
                <form method="post">
                    <div class="modal-body">
                        ...
                        <input type="text" name="email" placeholder="Email" class="form-control mb-2" required value="<?= $emailValue; ?>">
