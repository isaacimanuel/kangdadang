...
?>
    ...
    <head>
        ...
        <title>SIEKA | Daftar Produk E-Katalog - Admin</title>
                ...
                <main>
                    <div class="container-fluid">
                        ...
                        ?>
                            ...
                            <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#myModal">Tambah Data Produk</button><br>
                        <?php } else { ?>
                            <div class="navigation">
                                <a href="tipe.php">Kategori E-katalog</a>
                                <span style="font-size: 12px;"><i class="fas fa-chevron-right"></i></span>
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <form method="post" enctype="multipart/form-data">
                                                        <div class="modal-body">
                                                            Apakah Anda Yakin ingin mengedit produk <?= $namaproduk ?>?
                                                            <input type="hidden" name="idproduk" value="<?= $idproduk; ?>">
                                                            <br>
                                                            <br>
                                                            <small class="text-muted">Nama Produk</small>
                                                            <input type="text" name="namaproduk" value="<?= $namaproduk; ?>" placeholder="produk" class="form-control" required>
                                                            <br>
            ...
            <div class="modal-content">
                ...
                <form method="post" enctype="multipart/form-data">
                    <div class="modal-body">
                        ...
                        <input type="text" name="namaproduk" placeholder="Nama produk" class="form-control" required value="<?= $namaValue; ?>">
                        <br>
