...
?>
    ...
    <head>
        ...
        <title>SIEKA | Daftar Pesanan - Vendor</title>
                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                        ...
                                        <tbody>
                                            ...
                                            <?php
                                            $ambilsemuadatakatalog = mysqli_query($conn, "SELECT COUNT(*) as total_pesanan, d.iduser, u.username,u.nama
                                                FROM detailpesan d
                                                JOIN user_katalog u ON d.iduser = u.id
                                                WHERE d.idvendor = '$idvendor'
                                                GROUP BY d.iduser");
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td><?= $nama; ?></td>
                                                    <td>
                                                        <a href="detailpesan.php?iduser=<?= $data['iduser']; ?>" type="button" class="btn btn-secondary">
