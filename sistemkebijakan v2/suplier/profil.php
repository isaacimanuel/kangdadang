                        ...
                        <div class="col-lg-7">
                            <div class="card shadow-lg border-0 rounded-lg mt-5">
                                <div class="card-header">
                                    <h3 class="text-center font-weight-light my-4">Profil Vendor</h3>
                                </div>
                                <div class="card-body">
                                    <?php
                                    ...
                                    <form method="post">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <input class="form-control py-4" type="text" name="alamat" value="<?= $alamat; ?>" placeholder="Password" />
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="small mb-1" for="deskripsi">Deskripsi</label>
                                            <div class="input-group">
                                                <textarea class="form-control" id="deskripsi" name="deskripsi" placeholder="Deskripsi Vendor" rows="2"><?php echo $deskripsi; ?></textarea><br>
                                            </div>
                                        </div>
                                        <input type="hidden" name="id" value="<?= $id; ?>">
                                        <div class="form-group mt-4 mb-0"><button class="btn btn-primary btn-block" type="submit" name="updatevendor">Simpan</button></div>
                                    </form>
                                </div>
