...
?>
    ...
    <head>
        ...
        <title>SIEKA | Daftar Riwayat - Vendor</title>
                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                        ...
                                        <tbody>
                                            ...
                                            <?php
                                            $ambilsemuadatakatalog = mysqli_query($conn, "SELECT COUNT(*) as total_pesanan, r.iduser, u.username, u.nama, r.status_vendor 
                                                FROM riwayat r
                                                JOIN user_katalog u ON r.iduser = u.id
                                                WHERE r.idvendor = '$idvendor' AND r.status_vendor = 1
                                                GROUP BY r.iduser");
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td><?= $nama; ?></td>
                                                    <td>
                                                        <a href="riwayat.php?iduser=<?= $data['iduser']; ?>" type="button" class="btn btn-secondary">
