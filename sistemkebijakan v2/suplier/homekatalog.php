...
?>
    ...
    <head>
        ...
        <title>SIEKA | Beranda - Vendor</title>
        ...
        <style>
            ...
            .card {
                ...
                /* Atur ukuran teks pada card */
            }

            .card-title {
                font-size: 1rem;
                /* Atur ukuran teks pada judul card */
                margin-bottom: 0;
                color: black;
                /* Hilangkan margin bawah pada judul */
                text-decoration-line: none;
            }

            .card-img-top {
                object-fit: contain;
                /* Pastikan gambar mengisi ruang dengan benar */
                height: 70%;
                /* Atur tinggi gambar */
                width: auto;
            }
