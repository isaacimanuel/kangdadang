...
?>
    ...
    <head>
        ...
        <title>SIEKA | Kategori E-Katalog - SuperAdmin</title>
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-header">
                                                    <h4 class="modal-title">Edit Kategori Katalog</h4>
                                                ...
                                                <form method="post" enctype="multipart/form-data">
                                                    <div class="modal-body">
                                                        ...
                                                        <input type="text" name="namatipe" value="<?= $namatipe; ?>" placeholder="Kategori" class="form-control mb-3" required>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form method="post" enctype="multipart/form-data">
                    <div class="modal-body">
                        <small class="text-muted">Kategori</small>
                        <input type="text" name="namatipe" placeholder="Nama Kategori" class="form-control mb-3" required value="<?= $namaValue; ?>">
                        <small class="text-muted">Foto Kategori</small>
