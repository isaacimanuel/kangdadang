...
?>
    ...
    <head>
        ...
        <title>SISKA | Kelola User - SuperAdmin</title>
                                                        ...
                                                        <div class="modal-content">
                                                            ...
                                                            <form method="post">
                                                                <div class="modal-body">
                                                                    ...
                                                                    <input type="email" name="email" class="form-control mb-2" value="<?= $email; ?>" placeholder="Password">
            ...
            <div class="modal-content">
                ...
                <form method="post">
                    <div class="modal-body">
                        ...
                        <small class="text-muted">Password</small>
                        <input type="password" name="password" placeholder="Password" class="form-control" required value="<?= $passwordValue; ?>">
                        <br>
                        <button type="submit" class="btn btn-primary" name="adduser" style="width: 100%;">Kirim</button>
                    </div>
                </form>
