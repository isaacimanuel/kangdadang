...
?>
    ...
    <head>
        ...
        <title>SIEKA | Detail Pesanan - SuperAdmin</title>
                ...
                <main>
                    <div class="container-fluid">
                        ...
                        <div class="alert alert-warning alert-dismissible fade show mt-3" role="alert">
                            Silahkan Menunggu Konfirmasi, Setelah Mendownload Catatan Pesanan akan Dipihkan ke Riwayat Pesanan
                            <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                            </button>
                        </div>
                                        ...
                                        <form method="post" enctype="multipart/form-data">
                                            <div class="modal-body">
                                                ...
                                                <select name="kode_pesan" class="form-control" required>
                                                    ...
                                                    <?php
                                                    $result = mysqli_query($conn, "SELECT DISTINCT kode_pesan FROM detailpesan WHERE iduser = '$iduser' AND status = 0");
                                                ...
                                                <br>
                                                <button type="submit" class="btn btn-info" name="konfirmasipesansuperadmin" style="width: 100%;">Konfirmasi Pesanan</button>
                                            </div>
                                        </form>
                                            ...
                                            <table class="table table-bordered" width="100%" cellspacing="0">
                                                ...
                                                <tbody>
                                                    ...
                                                    ?>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <?php if ($status == 0) { ?>
                                                                    ...
                                                                    <button type="button" class="btn btn-danger" data-toggle="modal" data-target="#vendor<?= $id; ?>">
                                                        ...
                                                        <!-- Batal vendor Modal -->
                                                        <div class="modal fade" id="vendor<?= $id; ?>">
                                                            <div class="modal-dialog">
                                                                <div class="modal-content">
