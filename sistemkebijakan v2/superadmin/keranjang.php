...
?>
    ...
    <head>
        ...
        <title>SIEKA | Keranjang Pesanan - SuperAdmin</title>
                ...
                <main>
                    <div class="container-fluid">
                        ...
                        <div class="navigation">
                            <a href="daftarkeranjang.php">Daftar Keranjang</a>
                            <span>></span>
                            <a href="keranjang.php?iduser=<?= $iduser; ?>">Keranjang Pesanan</a>
                        </div>
                        <?php
                        ...
                        <div class=" card mb-4 mt-3">
                            <div class="card-header">
                                <button type="button" class="btn btn-success" data-toggle="modal" data-target="#pesan<?= $iduser; ?>">
                                    Pesan Keranjang
                                </button>
                            </div>
                            <div class="card-body">
                                <?php
                                $ambilsemuadatakatalog = mysqli_query($conn, "SELECT id,iduser,idvendor,idbarang,namabarang,merk, foto,vendor,harga_awal,SUM(harga) as total_harga, SUM(jumlah) as total_jumlah FROM keranjang WHERE iduser = '$iduser' GROUP BY namabarang, foto");
                                $i = 1;
                                        ...
                                        <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                            ...
                                            <tbody>
                                                ...
                                                ?>
                                                    ...
                                                    <div class="modal fade" id="delete<?= $id; ?>">
                                                        <div class="modal-dialog">
                                                            <div class="modal-content">
                                                                ...
                                                                <!-- Modal Header -->
                                                                <div class="modal-header">
                                                                    <h4 class="modal-title">Hapus Keranjang Barang</h4>
                                                    ...
                                                    <!-- Pesan Modal -->
                                                    <div class="modal fade" id="pesan<?= $iduser; ?>">
                                                        <div class="modal-dialog">
                                                            <div class="modal-content">
