...
if (isset($_SESSION['log']) && $_SESSION['role'] === 'superadmin_katalog') {
    ...
    if ($data_produk) {
        ...
        $result_tipe = mysqli_query($conn, "SELECT namatipe, idtipe FROM tipe WHERE idtipe = '$idtipe'");
...
?>
    ...
    <head>
        ...
        <title>SIEKA | Barang E-Katalog Sarana Prasarana - SuperAdmin</title>
                                            ...
                                            <a href="detailcard.php?id=<?= $id; ?>" class="card-link">
                                                <div class="card">
                                                    ...
                                                    <div class="card-content">
                                                        ...
                                                        <h6 class="card-text merk"><?= $merk; ?></h6>
                                                        <h6 class="card-text vendor" style="display:none;"><?= $vendor; ?></h6>
                                                        <h6 class="card-text harga">Rp. <?= number_format($data['harga'], 0, ',', '.'); ?></h6>
                    ...
                    <form method="get">
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                <small for="barang" class="text-muted">Cari berdasarkan nama barang:</small>
                            ...
                            <div class="form-group">
                                <small for="merk" class="text-muted">Pilih Merk:</small>
                            ...
                            <div class="form-group">
                                <small for="vendor" class="text-muted">Pilih Vendor:</small>
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    <small for="min_harga" class="text-muted">Harga Minimum:</small>
                                ...
                                <div class="form-group col-md-6">
                                    <small for="max_harga" class="text-muted">Harga Maksimum:</small>
        ...
        <div class="modal fade" id="myModal">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <form method="post" enctype="multipart/form-data">
                        <div class="modal-body">
                            <small class="text-muted">Foto Barang</small>
                            <input type="hidden" name="idvendor" id="idvendor" value="<?= $idvendor; ?>">
                            <input type="hidden" name="idproduk" value="<?= $idproduk; ?>">
                            ...
                            <small class="text-muted">Vendor</small>
                            <select name="vendor" class="form-control mb-2" id="selectVendor" required>
