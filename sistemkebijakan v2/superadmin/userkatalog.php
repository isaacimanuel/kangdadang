                ...
                <main>
                    <div class="container-fluid">
                        ...
                        <div class="navigation">
                            <a href="userkatalog.php">Kelola User</a>
                        </div>
                        <?php
                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                        ...
                                        <tbody>
                                            ...
                                            <?php
                                            $ambilsemuadatauser = mysqli_query($conn, "select * from user_katalog where role = 'user_katalog'");
                                            $i = 1;
                                                        ...
                                                        <div class="modal-content">
                                                            ...
                                                            <form method="post">
                                                                <div class="modal-body">
                                                                    ...
                                                                    <small>Nama</small>
                                                                    <input type="text" name="nama" placeholder="Nama" value="<?= $nama; ?>" class="form-control mb-3" required>
                                                                    <small>Email</small>
                                                                    <input type="email" name="email" placeholder="Email" value="<?= $email; ?>" class="form-control mb-3" required>
            ...
            <div class="modal-content">
                ...
                <form method="post">
                    <div class="modal-body">
                        ...
                        <input type="text" name="nama" placeholder="Nama" class="form-control mb-3" required value="<?= $namaValue; ?>">
                        <small class=" text-muted">Email</small>
                        <input type="email" name="Email" placeholder="email" class="form-control mb-3" required value="<?= $emailValue; ?>">
                        <small class=" text-muted">Password</small>
                        <input type="password" name="password" placeholder="Password" class="form-control" required value="<?= $passwordValue; ?>"><br>
                        <button type="submit" class="btn btn-primary" name="adduserkatalog" style="width: 100%;">Kirim</button>
                    </div>
                </form>
