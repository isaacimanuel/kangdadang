...
?>
    ...
    <head>
        ...
        <title>SIEKA | Riwayat Pesanan - User</title>
                ...
                <main>
                    <div class="container-fluid">
                        ...
                        <div class=" card mb-4 mt-3">
                                        ...
                                        <form method="post" enctype="multipart/form-data">
                                            <div class="modal-body">
                                                ...
                                                <select name="kode_pesan" class="form-control" required>
                                                    ...
                                                    <?php
                                                    $result = mysqli_query($conn, "SELECT DISTINCT kode_pesan FROM riwayat WHERE iduser = '$iduser' AND status_user = 1");
                            ...
                            while ($row = mysqli_fetch_assoc($result)) {
                                $kode_pesan = $row['kode_pesan'];
                                $ambilsemuadatakatalog = mysqli_query($conn, "SELECT * FROM riwayat WHERE iduser = '$iduser' AND kode_pesan = '$kode_pesan' AND status_user = 1");
                                                ...
                                                <tfoot>
                                                    <tr>
                                                        ...
                                                        <th colspan="5" class="text-right">
                                                            <?php
                                                            $resultTotal = mysqli_query($conn, "SELECT SUM(harga) as total FROM riwayat WHERE kode_pesan = '$kode_pesan' AND status_user = 1");
