...
?>
    ...
    <head>
        ...
        <title>SISKA | Proposal - Admin</title>
                                                        ...
                                                        <div class="modal-content">
                                                            ...
                                                            <form method="post" enctype="multipart/form-data">
                                                                <div class="modal-body">
                                                                    ...
                                                                    <br>
                                                                    <br>
                                                                    <button type="submit" class="btn btn-success" name="verifikasidataproposal1">Verifikasi</button>
                                                                    <button type="submit" class="btn btn-danger" name="tolakdataproposal">Tolak</button>
                                                                </div>
                                                            </form>
