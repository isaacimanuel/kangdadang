                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        if ($data['status'] == 1) {
                                                            ...
                                                            echo '<button type="button" class="btn btn-success" data-toggle="modal" data-target="#verifikasi' . $ids . '">Verifikasi</button>';
                                                        }
                                                        ?>
                                                        ...
                                                        <div class="modal-content">
                                                            ...
                                                            <form method="post" enctype="multipart/form-data">
                                                                <div class="modal-body">
                                                                    ...
                                                                    <br>
                                                                    <br>
                                                                    <button type="submit" class="btn btn-success" name="verifikasidatastandar">Verifikasi</button>
                                                                    <button type="submit" class="btn btn-danger" name="tidakverifdatastandar">Gagal Verifikasi</button>
                                                                </div>
                                                            </form>
