...
?>
    ...
    <head>
        ...
        <title>SISKA | Kebijakan - SuperAdmin</title>
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        <h1 class="mt-4">Daftar Kebijakan </h1>
                        <div class="card mb-4">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        if ($data['status'] == 1) {
                                                            ...
                                                            echo '<button type="button" class="btn btn-success" data-toggle="modal" data-target="#verifikasi' . $idk . '">Verifikasi</button>';
                                                        }
                                                        ?>
                                                        ...
                                                        <div class="modal-content">
                                                            ...
                                                            <form method="post" enctype="multipart/form-data">
                                                                <div class="modal-body">
                                                                    ...
                                                                    <br>
                                                                    <br>
                                                                    <button type="submit" class="btn btn-success" name="verifikasidatakebijakan">Verifikasi</button>
                                                                </div>
                                                            </form>
