...
?>
    ...
    <head>
        ...
        <title>SISKA | Institusi Kerja - SuperAdmin</title>
                                                ...
                                                <div class="modal fade" id="verifikasi<?= $idi; ?>">
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            ...
                                                            <!-- Modal Header -->
                                                            <div class="modal-header">
                                                                <h4 class="modal-title">Verifikasi Data Institusi</h4>
                                                                <button type="button" class="close" data-dismiss="modal">&times;</button>
                                                            </div>
                                                            ...
                                                            <form method="post" enctype="multipart/form-data">
                                                                <div class="modal-body">
                                                                    Apakah Anda Yakin ingin verifikasi data <?= $namainstitusi ?>?
                                                                    <input type="hidden" name="idi" value="<?= $idi; ?>">
                                                                    <br>
                                                                    <br>
                                                                    <button type="submit" class="btn btn-success" name="verifikasidatainstitusi">Verifikasi</button>
                                                                </div>
                                                            </form>
