            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        <h1 class="mt-4">Daftar Prosedur </h1>
                        <div class="card mb-4">
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <?php
                                                        if ($data['status'] == 1) {
                                                            echo '<button type="button" class="btn btn-info" disabled>Terverifikasi</button>';
                                                        } else {
                                                            echo '<button type="button" class="btn btn-success" data-toggle="modal" data-target="#verifikasi' . $idp . '">Verifikasi</button>';
                                                        }
                                                        ?>
                                                        ...
                                                        <div class="modal-content">
                                                            ...
                                                            <form method="post" enctype="multipart/form-data">
                                                                <div class="modal-body">
                                                                    ...
                                                                    <button type="submit" class="btn btn-primary" name="updatedataprosedur">Submit</button>
                                                                </div>
                                                            </form>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="modal fade" id="verifikasi<?= $idp; ?>">
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            ...
                                                            <form method="post" enctype="multipart/form-data">
                                                                <div class="modal-body">
                                                                    Apakah Anda Yakin ingin verifikasi data <?= $namaprosedur  ?>?
                                                                    <input type="hidden" name="idp" value="<?= $idp; ?>">
                                                                    <br>
                                                                    <br>
                                                                    <button type="submit" class="btn btn-success" name="verifikasidataprosedur">Verifikasi</button>
                                                                </div>
                                                            </form>
            ...
            <div class="modal-content">
                ...
                <form method="post" enctype="multipart/form-data">
                    <div class="modal-body">
                        ...
                        <input type="datetime-local" class="form-control" id="tanggal" name="tanggal" required>
                        <br>
                        <button type="submit" class="btn btn-primary" name="addnewdataprosedur">Submit</button>
                    </div>
                </form>
