...
require "../cek.php";
if (isset($_SESSION['log']) && $_SESSION['role'] === 'lpm') {
...
?>
    ...
    <head>
        ...
        <title>SISKA | Proposal - LPM</title>
                                                        ...
                                                        <div class="modal-content">
                                                            ...
                                                            <form method="post" enctype="multipart/form-data">
                                                                <div class="modal-body">
                                                                    ...
                                                                    <br>
                                                                    <br>
                                                                    <button type="submit" class="btn btn-success" name="verifikasiproposallpm">Verifikasi</button>
                                                                    <button type="submit" class="btn btn-danger" name="tolakproposallpm">Tolak</button>
                                                                </div>
                                                            </form>
