...
?>
    ...
    <head>
        ...
        <title>SISKA | Edit Form - LPM</title>
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <form method="post" enctype="multipart/form-data">
                                        ...
                                        <br>
                                        <div class="edit">
                                            <button type="submit" class="btn btn-primary" name="editproposal">Submit</button>
                                            <a href="proposal.php" class="btn btn-danger">Batal</a>
                                        </div>
                                    </form>
                                </div>
                            </div>
