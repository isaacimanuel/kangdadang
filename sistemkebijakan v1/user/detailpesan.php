...
?>
    ...
    <head>
        ...
        <title>SISKA | Detail Pesanan - User</title>
                                    ...
                                    <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                        ...
                                        <tbody>
                                            ...
                                            while ($data = mysqli_fetch_array($ambilsemuadatakatalog)) {
                                                ...
                                                $totalJumlah = number_format($data['total_jumlah'], 0, ',', '.');
                                            ?>
                                                <tr>
                                                    <td><?= $i++; ?></td>
                                                    <td>
                                                        ...
                                                        <div class="modal-content">
                                                            ...
                                                            <form method="post" enctype="multipart/form-data">
                                                                <div class="modal-body">
                                                                    ...
                                                                    <br>
                                                                    <button type="submit" class="btn btn-warning" name="editpesanan" style="width: 100%;">Edit Pesanan</button>
                                                                </div>
                                                            </form>
                                                        </div>
                                                    </div>
