...
?>
    ...
    <head>
        ...
        <title>SISKA | Kebijakan - Admin</title>
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        ?>
                                                            <button type="button" class="btn btn-danger" data-toggle="modal" data-target="#kesalahan<?= $idk; ?>">
                                                    ...
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-header">
                                                                <h4 class="modal-title">Update Data Kebijakan Direktorat</h4>
                                                            ...
                                                            <form method="post" enctype="multipart/form-data">
                                                                <div class="modal-body">
                                                                    ...
                                                                    <button type="submit" class="btn btn-primary" name="updatedatakebijakan" style="width: 100%;">Submit</button>
                                                                </div>
                                                            </form>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="modal fade" id="delete<?= $idk; ?>">
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            ...
                                                            <!-- Modal Header -->
                                                            <div class="modal-header">
                                                                <h4 class="modal-title">Hapus Data Kebijakan Direktorat</h4>
                                                                <button type="button" class="close" data-dismiss="modal">&times;</button>
                                                            </div>
                                                ...
                                                <div class="modal fade" id="kesalahan<?= $idk; ?>">
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">

                                                            <!-- Modal Header -->
                                                            <div class="modal-header">
                                                                <h4 class="modal-title">Catatan Data Kebijakan Direktorat</h4>
                                                                <button type="button" class="close" data-dismiss="modal">&times;</button>
                                                            </div>
                                                            ...
                                                            <form method="post" enctype="multipart/form-data">
                                                                <div class="modal-body">
                                                                    Mohon perbaiki data <?= $namakebijakan ?>
                                                                    <br>
                                                                    <br>
    ...
    <div class="modal fade" id="myModal">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <!-- Modal Header -->
                <div class="modal-header">
                    <h4 class="modal-title">Tambah Data Kebijakan Direktorat</h4>
                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                </div>
                ...
                <form method="post" enctype="multipart/form-data">
                    <div class="modal-body">
                        ...
                        <input type="datetime-local" class="form-control" id="tanggal" name="tanggal" required>
                        <br>
                        <button type="submit" class="btn btn-primary" name="addnewdatakebijakan" style="width: 100%;">Submit</button>
                    </div>
                </form>
