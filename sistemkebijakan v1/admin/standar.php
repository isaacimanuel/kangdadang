                                                        ...
                                                        <div class="modal-content">
                                                            ...
                                                            <form method="post" enctype="multipart/form-data">
                                                                <div class="modal-body">
                                                                    ...
                                                                    <button type="submit" class="btn btn-primary" name="updatedatastandar" style="width: 100%;">Submit</button>
                                                                </div>
                                                            </form>
                                                        </div>
                                                    </div>
            ...
            <div class="modal-content">
                ...
                <form method="post" enctype="multipart/form-data">
                    <div class="modal-body">
                        ...
                        <input type="datetime-local" class="form-control" id="tanggal" name="tanggal" required>
                        <br>
                        <button type="submit" class="btn btn-primary" name="addnewdatastandar" style="width: 100%;">Submit</button>
                    </div>
                </form>
