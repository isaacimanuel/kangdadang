                ...
                <main>
                    <div class="container-fluid">
                        ...
                        <div class="card mb-4">
                            ...
                            <?php
                            $ambilsemuadatakebijakan = mysqli_query($conn, "select * from fakultas where status = 2");
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        ?>
                                                            <button type="button" class="btn btn-danger" data-toggle="modal" data-target="#kesalahan<?= $id; ?>">
                                                        ...
                                                        <div class="modal-content">
                                                            ...
                                                            <form method="post" enctype="multipart/form-data">
                                                                <div class="modal-body">
                                                                    ...
                                                                    <button type="submit" class="btn btn-primary" name="updatedatafakultas" style="width: 100%;">Submit</button>
                                                                </div>
                                                            </form>
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div class="modal-content">
                                                            ...
                                                            <form method="post" enctype="multipart/form-data">
                                                                <div class="modal-body">
                                                                    ...
                                                                    <br>
                                                                    <br>
                                                                    <button type="submit" class="btn btn-danger" name="hapusdatakebijakanfakultas">Delete</button>
                                                                </div>
                                                            </form>
                                                ...
                                                <div class="modal fade" id="kesalahan<?= $id; ?>">
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">

                                                            <!-- Modal Header -->
                                                            <div class="modal-header">
                                                                <h4 class="modal-title">Catatan Data Kebijakan fakultas</h4>
                                                                <button type="button" class="close" data-dismiss="modal">&times;</button>
                                                            </div>
            ...
            <div class="modal-content">
                ...
                <form method="post" enctype="multipart/form-data">
                    <div class="modal-body">
                        ...
                        <input type="datetime-local" class="form-control" id="tanggal" name="tanggal" required>
                        <br>
                        <button type="submit" class="btn btn-primary" name="addnewdatafakultas" style="width: 100%;">Submit</button>
                    </div>
                </form>
