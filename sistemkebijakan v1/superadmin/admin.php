                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                        ...
                                        <tbody>
                                            ...
                                            <?php
                                            $ambilsemuadataadmin = mysqli_query($conn, "select * from user where role = 'admin' OR role = 'lpm' OR role ='daku'");
                                            $i = 1;
                                                        ...
                                                        <div class="modal-content">
                                                            ...
                                                            <form method="post">
                                                                <div class="modal-body">
                                                                    ...
                                                                    <br>
                                                                    <input type="email" name="emailbaru" class="form-control" value="<?= $email; ?>" placeholder="Email">
                                                                    <br>
                                                                    <input type="password" name="passwordbaru" class="form-control" value="<?= $password; ?>" placeholder="Password">
                                                                    <br>
                                                                    <input type="hidden" name="id" value="<?= $id; ?>">
                                                                    <button type="submit" class="btn btn-warning" name="updateadmin" style="width: 100%;">Edit</button>
                                                                </div>
                                                            </form>
                                                        ...
                                                        <div class="modal-content">
                                                            ...
                                                            <form method="post">
                                                                <div class="modal-body">
                                                                    ...
                                                                    <br>
                                                                    <br>
                                                                    <button type="submit" class="btn btn-danger" name="hapusadmin" style="width: 100%;">Hapus</button>
                                                                </div>
                                                            </form>
