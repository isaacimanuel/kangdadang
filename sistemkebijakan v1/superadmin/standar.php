...
?>
    ...
    <head>
        ...
        <title>SISKA | Standar - SuperAdmin</title>
                                    ...
                                    <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        if ($data['status'] == 1) {
                                                            ...
                                                            echo '<button type="button" class="btn btn-success" data-toggle="modal" data-target="#verifikasi' . $ids . '"><i class="fas fa-check"></i></button>&nbsp;';
                                                            echo '<button type="button" class="btn btn-danger" data-toggle="modal" data-target="#tolakverifikasi' . $ids . '"><i class="fas fa-times"></i></button>';
                                                        }
                                                        ?>
                                                ...
                                                <!-- Verifikasi Modal -->
                                                <div class="modal fade" id="verifikasi<?= $ids; ?>">
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">

                                                            <!-- Modal Header -->
                                                            <div class="modal-header">
                                                                <h4 class="modal-title">Verifikasi Data Standar </h4>
                                                                <button type="button" class="close" data-dismiss="modal">&times;</button>
                                                            </div>
                                                            ...
                                                            <form method="post" enctype="multipart/form-data">
                                                                <div class="modal-body">
                                                                    Apakah Anda Yakin ingin verifikasi data <?= $namastandar  ?>?
                                                                    <input type="hidden" name="ids" value="<?= $ids; ?>">
                                                                    <br>
                                                                    <br>
                                                                    <button type="submit" class="btn btn-success" name="verifikasidatastandar" style="width: 100%;">Verifikasi</button>
                                                                </div>
                                                            </form>
                                                ...
                                                <div class="modal fade" id="tolakverifikasi<?= $ids; ?>">
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">

                                                            <!-- Modal Header -->
                                                            <div class="modal-header">
                                                                <h4 class="modal-title">Tolak Data Standar</h4>
                                                                <button type="button" class="close" data-dismiss="modal">&times;</button>
                                                            </div>
                                                            ...
                                                            <form method="post" enctype="multipart/form-data">
                                                                <div class="modal-body">
                                                                    Apakah Anda Yakin ingin Tolak verifikasi data <?= $namastandar ?>?
                                                                    <input type="hidden" name="ids" value="<?= $ids; ?>">
                                                                    <br>
                                                                    <br>
                                                                    ...
                                                                    <br>
                                                                    <button type="submit" class="btn btn-danger" name="tidakverifdatastandar" style="width: 100%;">Tolak</button>
                                                                </div>
                                                            </form>
